...
namespace ORA_DAL
{
    public abstract class ODPDataAccess : IODPBackend
    {
        ...
        OracleConnection IODPBackendSource.Connection => throw new NotImplementedException();
        ...
        OracleDataReader IODPBackend.ExecuteDataReader(string query)
        {
            throw new NotImplementedException();
        }

        OracleDataReader IODPBackend.ExecuteDataReader(ProcParam procParam)
        {
            throw new NotImplementedException();
        }

        OracleDataReader IODPBackend.ExecuteDataReaderRefCur(string procname, ProcParam procParam, int indexRefCur)
        {
            throw new NotImplementedException();
        }
